...
Das Dokument listet auch nützliche Sätze für den Übergang zwischen Themen auf.
Am Ende der Präsentation sollte man eine Summary (Zusammenfassung) geben, um die wichtigsten Punkte zu rekapitulieren, 

z.B. „In summary…“ oder 
„To summarise my main points…“. 

Nachdem die wichtigsten Punkte wiederholt wurden, kann man Questions (Fragen) einladen, beispielsweise mit 

„Does anyone have any questions?“ oder 
„I am happy to answer any questions you may have“.
Das Dokument unterstreicht außerdem die Bedeutung eines professionellen Opening (Einstiegs), 

z.B. „Good afternoon ladies and gentlemen“ oder 
„Welcome to this presentation at Lingoda“. 
...
Einleitung (Introduction)
    ...
    - "As you’re aware, we’re here to talk about..."
Vorstellung des Themas und Struktur (Structuring the presentation)
    - "My talk is divided into four sections."
    - "There are three parts to this presentation."
    - "I will begin by talking about..."
    - "Then/next I will talk about..."
    - "Finally..."
    - "I will welcome questions at the end."
Übergänge und Wechsel des Themas (Changing topic)
    - "That brings me to my next point."
    - "Now, I’d like to move on to..."
    - "Let’s now turn to..."
Zusammenfassung und Abschluss (Summarising and closing)
    - "In summary…"
    - "To summarise my main points…"
    - "In conclusion…"
    - "Let me sum up my main points."
    - "That brings me to the end…"
Fragen stellen (Inviting questions)
    - "Does anyone have any questions?"
    - "Would anyone like to ask any questions?"
    - "I’m now happy to answer any questions you may have."
    - "Please don’t hesitate to ask questions now."
Begrüßung und Eröffnung (Opening statements)
    - "Good afternoon ladies and gentlemen."
    - "Hi everyone, welcome."
    - "I would like to welcome you on behalf of Lingoda."
    - "Welcome to this presentation at Lingoda."
