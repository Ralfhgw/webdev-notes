...
Das Dokument enthält auch Übungen, bei denen man darüber spricht, wie sich Arbeiten bei den Vereinten Nationen von der in einer Botschaft unterscheiden, sowie die Unterschiede zwischen einer Botschaft (embassy) und einem Konsulat (consulate). Zudem werden wichtige Eigenschaften und Qualifikationen für Diplomaten erörtert (Page 15, T3).

#### Beispielsätze (auf Englisch):
- "A diplomat also has the job of collecting information that could affect their home country."
- "Part of their role is to negotiate treaties and agreements."
- "The mission of a diplomat is to form and maintain international relations."

#### Eigene zusätzliche Beispiele:
- "Diplomats often participate in high-level meetings with officials from other countries."
- "Effective communication skills are essential for successful negotiations."
- "A good diplomat must be adaptable and culturally aware."