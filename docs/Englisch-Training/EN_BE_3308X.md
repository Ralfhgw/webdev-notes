...
<a href={useBaseUrl('english/EN_BE_3308X-annotated.pdf')} target="_blank" rel="noopener">EN_BE_3308X - Using modals verbs to express certainty</a>
...
Es werden nützliche Phrases vorgestellt, um Konflikte zu lösen, zum Beispiel:
    ...
    - "I recognise I was at fault and I apologise."
    
Das Ziel ist, die tone (Ton) und mood (Stimmung) in einer Diskussion zu kontrollieren, Missverständnisse zu vermeiden und durch negotiation (Verhandlung) gemeinsam eine win-win-Lösung zu finden.
Der Text hebt zudem hervor, dass erfolgreiche Konfliktlösung oft compromise erfordert, also das Ändern der eigenen Position oder das Anpassen der Forderungen. Ein Beispiel dafür ist: "The company and the employees eventually reached a compromise: instead of increasing their wages, they were allowed to work fewer hours for the same pay."
...
Nützliche Phrasen für Konfliktlösung und Verhandlung
    ...
    - "...I think it‘d be best if we could try to resolve our differences." (...Ich denke, es wäre am besten, wenn wir versuchen könnten, unsere Differenzen zu klären.)
    - "It’s unfortunate that things have got so heated." (Es ist schade, dass die Dinge so hitzig geworden sind.)
    - "I recognise I was at fault and I apologise." (Ich erkenne, dass ich Schuld habe, und entschuldige mich.)
    - "You can acknowledge someone else’s point of view while still making your own opinion clear." (Du kannst die Sichtweise des anderen anerkennen und gleichzeitig deine eigene Meinung deutlich machen.)
...
Diese Phrasen helfen dabei, Konflikte respektvoll und konstruktiv zu lösen, indem sie sowohl Verständnis) als auch Kompromissbereitschaft ausdrücken.
