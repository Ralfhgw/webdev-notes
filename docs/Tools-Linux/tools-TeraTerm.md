- Tera Term zeigt nur Farben, ändert sie nicht.
- Farben wie „Verzeichnis = Blau“ kommen vom Linux-Shell-System.
- Du kannst das über LS_COLORS und .bashrc anpassen.
```
vboxuser@Ubuntu:/media/sf_dci_training/websites$ echo $LS_COLORS
...
```
Die Farbe für die Anzeige der Verzeichnisse soll geändert werden. 
```
di=01;34
...
ändern in: 
DIR 01;34 # directory --> DIR 01;33 # directory
